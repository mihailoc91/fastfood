...
public class DobavljacUpdate extends javax.swing.JPanel implements IZaposleni {
    String naziv;
    String pib;
    String adresa;
    String telefon;
    ...
    int id;
    public DobavljacUpdate(int id) throws SQLException {
        initComponents();
        this.id=id;
        Dobavljac dobavljac = Dobavljac.getDobavljac(this.id);
        jTextField1.setText(dobavljac.getNaziv());
        jTextField2.setText(dobavljac.getPib());
        jTextField3.setText(dobavljac.getTelefon());
        jTextField4.setText(dobavljac.getAdresa());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            ControllerExit.updateDobavljac(this.id,naziv, pib, adresa, telefon,op);
            JFrame jf1 = (JFrame)SwingUtilities.getAncestorOfClass(JFrame.class, this);
            ControllerExit.setJTableStartLD(DobavljacOut.jt,4);
            DobavljacOut.jLista1.setModel(ControllerExit.setJListModel(1,4));
            jf1.setVisible(false);
            jf1.dispose();
            

        }catch (SQLException ex) {
            Logger.getLogger(DobavljacUpdate.class.getName()).log(Level.SEVERE, null, ex);}
